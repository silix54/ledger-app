// Version: 6.1 - Final Phase 3 (Dashboard Layout Controls)
import { useState, useMemo, useRef, useEffect } from "react";
import Papa from "papaparse";
import { BarChart, Bar, LineChart, Line, AreaChart, Area, PieChart, Pie, Cell, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer } from "recharts";
import { Upload, Download, Plus, AlertCircle, Check, Copy, ChevronDown, Trash2, Settings, FolderOpen, Sun, Moon, X, Pencil, Undo2, Printer, ArrowUp, ArrowDown, LayoutGrid } from "lucide-react";
          ...
          <div style={card}>
            ...
            <div style={{ overflowX: "auto" }}>
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                ...
                <tbody>
                  {pagedTxns.map(t => editingTxnId === t.id ? (
                    <tr key={t.id}>
